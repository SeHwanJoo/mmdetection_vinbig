...
class AttentionOriginalV1(nn.Module):
    def __init__(self,
                 in_channels,
                 out_channels,
                 num_outs,
        ...
        super(AttentionOriginalV1, self).__init__()
...
class SpatialGate(nn.Module):
    def __init__(self, levels):
        ...
        self.attention_conv = BasicConv(2 * levels, 3, kernel_size, stride=1, padding=(kernel_size - 1) // 2, relu=False)
